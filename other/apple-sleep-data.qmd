...
Get the amount of sleep for that row by subtracting the `endDate` by the `startDate`. Add up the sleep activity for each night by grouping by the `creationDate`.
...
[Taras Kaduk](https://taraskaduk.com/posts/2019-03-23-apple-health/)

[Relevant Miscellany](https://www.relevantmisc.com/r/2020/06/01/baby-sleep-radial/)

[This stackoverflow question](https://stackoverflow.com/questions/68578242/plot-arrival-and-departure-times-that-cross-midnight)
