...
```{r fig.width=8, fig.height=5, fig.showtext=TRUE}
sleep_by_wday |>
  ggplot() +
  geom_col(aes(
    x = wday,
...
[Taras Kaduk's blog](https://taraskaduk.com/posts/2019-03-23-apple-health/) who also used R to gather Apple Health data.
