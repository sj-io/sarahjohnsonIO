...
```{r}
csa <- read_sf("data/geo/csa/combined_statistical_area.shp")
cbsa <- read_sf("data/geo/cbsa/core_based_statistical_area.shp")
csaCounties <- read_sf("data/geo/county/counties_in_csa.shp")
counties <- read_sf("data/geo/county/counties_in_cbsa.shp")
sld <- read_sf("data/geo/district-state-legislative/state_legislative_districts.shp")
places <- read_sf("data/geo/place/places_in_cbsa.shp")
urb <- read_sf("data/geo/urban-area/urban_area.shp")
zcta <- read_sf("data/geo/zcta/zctas.shp")
puma <- read_sf("data/geo/pumas/pumas.shp")
shelby <- read_sf("data/geo/county/shelby.shp")
memphis <- read_sf("data/geo/place/memphis.shp")
csd <- read_sf("data/geo/county-subdivision/county_subdivisions.shp")
tracts <- read_sf("data/geo/tract/tracts_21.shp")
blkgrp <- read_sf("data/geo/block-group/block_groups.shp")
vote <- read_sf("data/geo/district-voting/voting_districts.shp")
school <- read_sf("data/geo/district-school/school_districts.shp")
cong <- read_sf("data/geo/district-congressional/congressional_districts.shp")
cong2 <- read_sf("data/geo/district-congressional/congressional_districts_2.shp")
```
